...
export const en: Translations = {
  ...
  cron: {
    ...
    last: 'Last:',
    next: 'Next:',
    historyUnavailable: 'Execution history could not be refreshed. Previously loaded records may be stale.',
    historyRetry: 'Retry',
    historyLegacy: 'This backend provides conversations only; job execution results are unavailable.',
    historyConversations: 'Conversations',
    historyProcess: 'Process',
    historyDelivery: 'Message delivery',
    noRuns: 'No runs yet',
    manage: 'Manage',
    showRuns: 'Show runs',
    hideRuns: 'Hide runs',
