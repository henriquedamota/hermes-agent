...
export const ar = defineLocale({
  ...
  cron: {
    ...
    last: 'آخر تشغيل',
    next: 'التالي',
    historyUnavailable: 'تعذر تحديث سجل التنفيذ. قد تكون السجلات المعروضة قديمة.',
    historyRetry: 'إعادة المحاولة',
    historyLegacy: 'يوفر هذا الخادم المحادثات فقط؛ نتائج تنفيذ المهام غير متاحة.',
    historyConversations: 'المحادثات',
    historyProcess: 'العملية',
    historyDelivery: 'تسليم الرسالة',
