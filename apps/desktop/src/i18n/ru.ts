...
export const ru = defineLocale({
  ...
  cron: {
    ...
    last: 'Последний:',
    next: 'Следующий:',
    historyUnavailable: 'Не удалось обновить историю выполнений. Загруженные записи могут быть устаревшими.',
    historyRetry: 'Повторить',
    historyLegacy: 'Этот сервер предоставляет только беседы; результаты выполнения заданий недоступны.',
    historyConversations: 'Беседы',
    historyProcess: 'Процесс',
    historyDelivery: 'Доставка сообщения',
